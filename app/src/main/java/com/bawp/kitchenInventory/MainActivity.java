...
import com.bawp.kitchenInventory.adapter.OnProductClickListener;
...
public class MainActivity extends AppCompatActivity implements OnProductClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_grocery_list){
    ...
    public void onProductClick(Product product) {
        sharedViewModel.selectItem(product);
        sharedViewModel.setIsEdit(true);
        showBottomSheetDialog();
    }

    @Override
    public void onProductDeleteButtonClick(Product product) {
        Log.d("Click", "onClick: " + product.getIngredient());
        ProductViewModel.delete(product);
        //TODO: create popup to verify user wants to delete
